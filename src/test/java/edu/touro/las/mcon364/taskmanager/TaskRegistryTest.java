...
class TaskRegistryTest {
    ...
    void testAdd() {
        ...
        assertEquals(task, registry.get("Test task").orElseThrow(),
            "Retrieved task should equal added task");
    }
    ...
    void testAddReplacement() {
        ...
        assertEquals(Priority.HIGH, registry.get("Test task").orElseThrow().priority(),
